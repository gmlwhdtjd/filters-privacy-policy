    ...
    return (
      <div className="App">
        <header className="App-header">
          ...
          <h1 className="App-title">Filters - Privacy Policy</h1>
        </header>
        {this._content("en")}
      </div>
    );
    ...
    if (lang === "en") {
      return (
        <div className="content">
          <p> 
            Team Bartender 3 built the Filters app as an Open Source app. This SERVICE is provided by Team Bartender 3 at no cost and is intended for use as is.
          </p> 
          <p> 
          ...
          <p> 
            The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, which is accessible at Filters unless otherwise defined in this Privacy Policy.
          </p> 
          <p><strong>Information Collection and Use</strong></p> 
          <p> 
            For a better experience, while using our Service, we may require you to provide us with certain personally identifiable information, including but not limited to Camera. The information that we request is will be retained by us and used as described in this privacy policy.
          </p> 
          <p>
